...
```typescript
const message =
  err instanceof Cards402Error ? err.message : 'An internal error occurred. Check server logs.';
```
...
The README explicitly documents: _"protect /admin via Cloudflare Access or similar."_ This is an external dependency that is easy to misconfigure or forget.
